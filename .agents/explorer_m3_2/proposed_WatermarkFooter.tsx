  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2">
        <div className="w-5 h-5 rounded-md bg-undip-navy/10 flex items-center justify-center text-undip-navy border border-undip-navy/20">
          <BarChart2 className="w-3 h-3 text-undip-blue" />
        </div>
